                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className="text-sm text-gray-600 dark:text-gray-400 bg-amber-500/10 px-3 py-1 rounded-full">
                        {edu.year}
                      </span>
                    </div>
                    <p className="text-gray-900 dark:text-white mb-2">{edu.institution}</p>
