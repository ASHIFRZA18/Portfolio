...
const Experience = () => {
  return (
    <section id="experience" className="py-24 bg-zinc-900 dark:bg-zinc-900">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-16">
          <div className="space-y-8">
            {experience.map((exp) => (
              <Card
                key={exp.id}
                className="bg-black border-amber-500/20 hover:border-amber-500/50 transition-all duration-300 transform hover:scale-[1.02]"
              >
        ...
        {/* Certificates */}
        <div>
          <h3 className="text-3xl font-bold text-white dark:text-white mb-8 text-center">
            Certifications
          </h3>
            ...
            {certificates.map((cert) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-400 dark:text-gray-400 text-sm">{cert.issuer}</p>
                </CardContent>
              </Card>
            ))}
          </div>
